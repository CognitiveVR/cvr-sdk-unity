...
public class ControllerInputTracker : MonoBehaviour
{
    ...
    bool isRight;
    DynamicObject dynamic;
    Varjo.Varjo_SteamVR_Controller.Device ControllerDevice;
    ...
    IEnumerator SlowInit()
    {
        ...
        {
            yield return new WaitForSeconds(1);
                Varjo.Varjo_SteamVR_TrackedObject o = GetComponent<Varjo.Varjo_SteamVR_TrackedObject>();
            if (o != null)
            {
                ControllerDevice = Varjo.Varjo_SteamVR_Controller.Input((int)o.index);
            }
        }
    }
