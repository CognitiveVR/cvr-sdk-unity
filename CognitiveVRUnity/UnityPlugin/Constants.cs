...
namespace CognitiveVR
{
    public static class Constants
    {
        ...
        {
            return String.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version,"/versions/", versionid, "/objects"); //changed api to data
        }

        //POST dynamic object manifest
        public static string POSTDYNAMICMANIFEST(string sceneid, int versionnumber)
        {
            return String.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/objects/", sceneid,"?version=", versionnumber);
        }
        ...
        {
            return String.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/objects/", sceneid,"/",exportdirectory,"?version=", versionnumber);
        }

        //GET scene settings and read scene version
        public static string GETSCENEVERSIONS(string sceneid)
        {
            return String.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/scenes/", sceneid); //changed api to data
        }

        //POST scene screenshot
        public static string POSTSCREENSHOT(string sceneid, int versionnumber)
        {
            return String.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/scenes/", sceneid,"/screenshot?version=", versionnumber);
        }

        //POST upload decimated scene
        public static string POSTNEWSCENE()
        {
            return "https://" + CognitiveVR_Preferences.Instance.Gateway + "/v"+ version+"/scenes";
        }

        //POST upload and replace existing scene
        public static string POSTUPDATESCENE(string sceneid)
        {
            return String.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/scenes/", sceneid);
        }
        ...
        {
            return string.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/dynamics/", sceneid, "?version=",versionnumber.ToString());
        }

        //POST gaze json data to scene explorer
        public static string POSTGAZEDATA(string sceneid, int versionnumber)
        {
            return string.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/gaze/", sceneid, "?version=", versionnumber.ToString());
        }

        //POST event json data to scene explorer
        public static string POSTEVENTDATA(string sceneid, int versionnumber)
        {
            return string.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/events/", sceneid, "?version=", versionnumber.ToString());
        }

        //POST sensor json data to scene explorer
        public static string POSTSENSORDATA(string sceneid, int versionnumber)
        {
            return string.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/sensors/", sceneid, "?version=", versionnumber.ToString());
        }
        ...
        {
            return string.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version, "/questionSetHooks/", hookname, "/questionSet");
        }
        //POST question set responses
        public static string POSTEXITPOLLRESPONSES(string questionsetname, int questionsetversion)
        {
            return string.Concat("https://", CognitiveVR_Preferences.Instance.Gateway, "/v", version,"/questionSets/", questionsetname, "/",questionsetversion.ToString(), "/responses");
        }
    }
}
