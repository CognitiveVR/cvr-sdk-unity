...
#region Auth Keys
    ...
    void SelectSDKUpdate()
    {
        GUI.Label(steptitlerect, "STEP 3 - SELECT SDK", "steptitle");
            ...
            List<string> sdknames = new List<string>() { "OpenXR", "Windows Mixed Reality", "OpenVR 1.1.4 (SteamVR)", "Oculus", "HP Omnicept Runtime", "SRanipal Runtime", "None", "SteamVR SDK 1.2", "Pico Unity XR Platform 1.2.3 (eye tracking)", "Pupil Labs SDK 1.0 (eye tracking)", "Vive Wave 3.0.1", "Varjo 2.3 (eye tracking)", "PicoVR Unity SDK 2.8.4 (eye tracking)", "Tobii XR 1.8.0.168 (eye tracking)", "Fove SDK 3.1.2 (eye tracking)", "ARCore SDK (Android)", "ARKit SDK (iOS)", "Hololens SDK", "Neurable 1.4", "SnapdragonVR 3.0.1 SDK" };
            List<string> sdkdefines = new List<string>() { "CVR_XR", "CVR_WINDOWSMR", "CVR_STEAMVR2", "CVR_OCULUS", "CVR_OMNICEPT", "CVR_VIVEPROEYE", "CVR_DEFAULT", "CVR_STEAMVR", "CVR_PICOXR", "CVR_PUPIL", "CVR_VIVEWAVE", "CVR_VARJO", "CVR_PICOVR", "CVR_TOBIIVR", "CVR_FOVE", "CVR_ARCORE", "CVR_ARKIT", "CVR_HOLOLENS", "CVR_NEURABLE", "CVR_SNAPDRAGON" };
