...
namespace Cognitive3D
{
    ...
    public class DynamicObject : MonoBehaviour
    {
        ...
        internal enum CommonDynamicMesh
        {
            ...
            QuestProTouchLeft = 15,
            QuestProTouchRight = 16,
            QuestPlusTouchLeft = 17,
            QuestPlusTouchRight = 18,
            PicoNeoControllerLeft = 19,
            PicoNeoControllerRight = 20,
            PicoNeo3ControllerLeft = 21,
            PicoNeo3ControllerRight = 22,
            ViveFocusControllerLeft = 23,
            SteamIndexLeft = 24,
            SteamIndexRight = 25,
            PicoNeo4ControllerLeft = 26,
            PicoNeo4ControllerRight = 27,
            Unknown = 28,
        }
        ...
        {
            vive_controller = 0, //wand
            vive_focus_controller_right = 1,
            vive_focus_controller_left = 2,
            oculus_rift_controller_left = 3,
            oculus_rift_controller_right = 4,
            oculus_quest_touch_left = 5,
            oculus_quest_touch_right = 6,
            quest_pro_touch_left = 7,
            quest_pro_touch_right = 8,
            quest_plus_touch_left = 9,
            quest_plus_touch_right = 10,
            windows_mixed_reality_controller_left = 11,
            windows_mixed_reality_controller_right = 12,
            pico_neo_2_eye_controller_left = 13,
            pico_neo_2_eye_controller_right = 14,
            pico_neo_3_eye_controller_left = 15,
            pico_neo_3_eye_controller_right = 16,
            pico_neo_4_eye_controller_left = 17,
            pico_neo_4_eye_controller_right = 18,
            steam_index_left = 19,
