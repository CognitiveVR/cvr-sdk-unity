        ...
        public override void OnInspectorGUI()
        {
            ...
            if (foldout)
            {
                ...
                if (targets.Length == 1)
                {
                    ...
                    var dyn = targets[0] as DynamicObject;
                    dyn.inputType = (DynamicObject.InputType)EditorGUILayout.EnumPopup(new GUIContent("Input Type","Used if this controller cannot be identified at runtime"),dyn.inputType);
                    dyn.IsController = dyn.inputType == DynamicObject.InputType.Controller || dyn.inputType == DynamicObject.InputType.Hand;
                    ...
                    EditorGUI.BeginDisabledGroup(dyn.inputType == DynamicObject.InputType.None);
                    dyn.IsRight = EditorGUILayout.Toggle("Is Right Hand",dyn.IsRight);
                    // EditorGUI.BeginDisabledGroup(dyn.inputType == DynamicObject.InputType.Hand);
