...
#region Controllers
        ...
        void ControllerUpdate()
        {
            ...
            else
            {
                if (GUI.Button(checkboxRect, EditorCore.BoxEmpty, "image_centered"))
                {
                    ...
                    Cognitive3D_Preferences.Instance.AutoPlayerSetup = true;
                }
                ...
                AllSetupComplete = (Cognitive3D_Preferences.Instance.AutoPlayerSetup || (leftControllerIsValid && rightControllerIsValid))
        ...
        void ApplyOculusSettings()
        {
            ...
            if (wantPassthroughEnabled)
            {
                var passthrough = FindFirstObjectByType<Passthrough>();
                if (passthrough == null)
                {
        ...
        void DrawNextButton()
        {
            ...
            switch (currentPage)
            {
                ...
                #else
                    appearDisabled = !isSetupComplete && !Cognitive3D_Preferences.Instance.AutoPlayerSetup;
                    if (appearDisabled)
                    {
                        onclick += () =>
                        {
